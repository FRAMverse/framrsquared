...
msf_mortalities_coho_ <- function(fram_db){
  ...
  mortalities_ |>
    ...
    tidyr::pivot_wider(names_from = "mark_status", values_from = "value") |>
...
msf_landed_catch_coho_ <- function(fram_db){
  ...
  landed_catch |>
    ...
    tidyr::pivot_wider(names_from = "mark_status", values_from = "msf_landed_catch") |>
    `attr<-`('species', fram_db$fram_db_species)
}
...
msf_encounters_coho_ <- function(fram_db){
  ...
  encounters |>
    ...
    tidyr::pivot_wider(names_from = "mark_status",
                       values_from = "msf_encounter") |>
    `attr<-`('species', fram_db$fram_db_species)
}
